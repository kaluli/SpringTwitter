		...
		<div class="busqueda">
			...
			<div class="row">				 
				<div class="col-md-5" id ="seguidores">
						...
						<div>
							<p>
							<a href='${pageContext.request.contextPath}/verPerfil.html?id=<c:out value="${usuario.id}"/>'>
							${usuario.nombre} ${usuario.apellido} (@${usuario.usuario}) </a>
							<a href='${pageContext.request.contextPath}/seguir.html?id=<c:out value="${usuario.id}"/>'> 
							<span style="float:right;"><button class="btn btn-primary" data-target="#themodal" data-toggle="modal">Seguir</button></span>
							</a></p> 
		                </div>
						</c:forEach>
		  	  	</div>					  
